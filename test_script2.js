var XLSX={};var google={maps:{Marker:function(){this.addListener=function(){};this.setIcon=function(){};},SymbolPath:{CIRCLE:0},event:{trigger:function(){}}}};function api(){}function toast(){}function initMap(){return null;}function addMarker(){}function closeModal(){}function openModal(){}function loadRoutes(){}
...
function abrirModalVeiculo(id){document.getElementById('modal-veiculo-completo').style.display='flex';}
function salvarVeiculoCompleto(){toast('Veiculo salvo!','success');}
