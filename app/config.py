...
raw_db = os.getenv("DATABASE_URL", "sqlite:///./fleet.db")
DATABASE_URL_SYNC = raw_db.replace("postgresql://", "postgresql+psycopg2://") if raw_db.startswith("postgresql://") else raw_db
