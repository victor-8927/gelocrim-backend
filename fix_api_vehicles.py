new_content = '''from uuid import uuid4
...
with open(r'C:\fleet-cloud\app\routers\vehicles.py', 'w', encoding='utf-8') as f:
    f.write(new_content)

print('vehicles.py atualizado com todos os novos campos!')
