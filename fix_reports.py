...
# Corrige o reports.py adicionando o endpoint /dashboard que estava faltando
reports_content = '''from datetime import date
...
path = r"C:\fleet-cloud\app\routers\reports.py"
with open(path, "w", encoding="utf-8") as f:
    f.write(reports_content)

print("reports.py corrigido com sucesso!")
