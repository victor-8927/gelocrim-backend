...
# ── 1. Adiciona colunas novas no banco ────────────────────────────
...
novas = [
    ...
    ('cnh_foto',      'TEXT'),
    ('dia_folga',     'TEXT'),
    ('carga_horaria', 'TEXT DEFAULT "07:00-17:00"'),
    ('hora_almoco',   'TEXT DEFAULT "12:00-13:00"'),
]
...
# ── 2. Atualiza drivers.py com novos campos ───────────────────────
...
with open(r'C:\fleet-cloud\app\routers\drivers.py', 'w', encoding='utf-8') as f:
    f.write(new_api)
print('drivers.py atualizado com todos os novos campos!')
